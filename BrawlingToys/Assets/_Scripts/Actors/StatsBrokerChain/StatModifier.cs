...
namespace BrawlingToys.Actors
{
    public abstract class StatModifier : IDisposable
    {
        ...
        // Passar valor 0 ou negativo de dura��o ocasionar� a dura��o infinita desse modificador.
        ...
        public void Dispose()
        {
            // Cada StatModifier pode precisar de uma manipula��o diferente quando os descartamos
